class RenderWorldMap {
  ...
  render() {
    ...
    const legendMap = document.createElement("h1");

    legendMap.classList.add("legend");
    map.classList.add("map");

    this.app.appendChild(map);
    this.app.appendChild(legendMap);
    ...
    const selectLegend = this.app.querySelector(".legend");
    const selectPaths = selectMap.querySelectorAll("svg path");
...
const renderWorldMap = new RenderWorldMap();
